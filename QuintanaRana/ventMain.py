...
class Ui_ventMain(object):
    def setupUi(self, ventMain):
        ...
        self.btnAltaFac.setMaximumSize(QtCore.QSize(275, 20))
        ...
        self.btn = QtWidgets.QPushButton(self.tab2)
        self.btn.setGeometry(QtCore.QRect(640, 60, 28, 28))
        self.btn.setMinimumSize(QtCore.QSize(28, 28))
        self.btn.setMaximumSize(QtCore.QSize(28, 28))
        self.btn.setText("")
        icon3 = QtGui.QIcon()
