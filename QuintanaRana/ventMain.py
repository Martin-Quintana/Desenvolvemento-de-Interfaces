...
class Ui_ventMain(object):
    def setupUi(self, ventMain):
        ...
        self.btnGuardaFac = QtWidgets.QPushButton(self.layoutWidget_7)
        self.btnGuardaFac.setMinimumSize(QtCore.QSize(75, 20))
        self.btnGuardaFac.setMaximumSize(QtCore.QSize(275, 20))
        self.btnGuardaFac.setObjectName("btnGuardaFac")
        self.horizontalLayout_7.addWidget(self.btnGuardaFac)
        self.btnModifcli_2 = QtWidgets.QPushButton(self.layoutWidget_7)
        self.btnModifcli_2.setMinimumSize(QtCore.QSize(75, 20))
        self.btnModifcli_2.setMaximumSize(QtCore.QSize(75, 20))
        self.btnModifcli_2.setObjectName("btnModifcli_2")
        self.horizontalLayout_7.addWidget(self.btnModifcli_2)
        self.btnBorracli_2 = QtWidgets.QPushButton(self.layoutWidget_7)
        self.btnBorracli_2.setMinimumSize(QtCore.QSize(75, 20))
        self.btnBorracli_2.setMaximumSize(QtCore.QSize(75, 20))
        self.btnBorracli_2.setObjectName("btnBorracli_2")
        self.horizontalLayout_7.addWidget(self.btnBorracli_2)
        ...
        self.lblFactura_2 = QtWidgets.QLabel(self.tab2)
        self.lblFactura_2.setGeometry(QtCore.QRect(650, 10, 91, 20))
        self.lblFactura_2.setMinimumSize(QtCore.QSize(30, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.lblFactura_2.setFont(font)
        self.lblFactura_2.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.lblFactura_2.setObjectName("lblFactura_2")
        self.txtDNIFactura = QtWidgets.QLineEdit(self.tab2)
        self.txtDNIFactura.setGeometry(QtCore.QRect(640, 30, 111, 20))
        self.txtDNIFactura.setStyleSheet("background-color: rgb(197, 236, 230);")
        self.txtDNIFactura.setText("")
        self.txtDNIFactura.setObjectName("txtDNIFactura")
        self.btnBuscacli_2 = QtWidgets.QPushButton(self.tab2)
        self.btnBuscacli_2.setGeometry(QtCore.QRect(640, 60, 28, 28))
        self.btnBuscacli_2.setMinimumSize(QtCore.QSize(28, 28))
        self.btnBuscacli_2.setMaximumSize(QtCore.QSize(28, 28))
        self.btnBuscacli_2.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:/Users/a21martinqr/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\../../../../../.designer/backup/img/lupa.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnBuscacli_2.setIcon(icon3)
        self.btnBuscacli_2.setIconSize(QtCore.QSize(20, 20))
        self.btnBuscacli_2.setObjectName("btnBuscacli_2")
        ...
        self.btnProecesarVenta = QtWidgets.QPushButton(self.frame)
        self.btnProecesarVenta.setGeometry(QtCore.QRect(210, 360, 91, 23))
        self.btnProecesarVenta.setObjectName("btnProecesarVenta")
        ...
        self.btnBuscacli_3 = QtWidgets.QPushButton(self.tab2)
        self.btnBuscacli_3.setGeometry(QtCore.QRect(680, 60, 28, 28))
        self.btnBuscacli_3.setMinimumSize(QtCore.QSize(28, 28))
        self.btnBuscacli_3.setMaximumSize(QtCore.QSize(28, 28))
        self.btnBuscacli_3.setText("")
        self.btnBuscacli_3.setIcon(icon3)
        self.btnBuscacli_3.setIconSize(QtCore.QSize(20, 20))
        self.btnBuscacli_3.setObjectName("btnBuscacli_3")
        self.btnBuscacli_4 = QtWidgets.QPushButton(self.tab2)
        self.btnBuscacli_4.setGeometry(QtCore.QRect(720, 60, 28, 28))
        self.btnBuscacli_4.setMinimumSize(QtCore.QSize(28, 28))
        self.btnBuscacli_4.setMaximumSize(QtCore.QSize(28, 28))
        self.btnBuscacli_4.setText("")
        self.btnBuscacli_4.setIcon(icon3)
        self.btnBuscacli_4.setIconSize(QtCore.QSize(20, 20))
        self.btnBuscacli_4.setObjectName("btnBuscacli_4")
        ...
        self.tabServicios.setGeometry(QtCore.QRect(10, 140, 780, 250))
        self.tabServicios.setMinimumSize(QtCore.QSize(780, 250))
        self.tabServicios.setMaximumSize(QtCore.QSize(780, 250))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:/Users/a21martinqr/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/salida.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSalir.setIcon(icon4)
        self.actionSalir.setObjectName("actionSalir")
        self.actionSalibar = QtGui.QAction(ventMain)
        self.actionSalibar.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:/Users/a21martinqr/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/pushDB.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionpushDB.setIcon(icon5)
        self.actionpushDB.setObjectName("actionpushDB")
        self.actionpullDB = QtGui.QAction(ventMain)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("C:/Users/a21martinqr/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/pullDB.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionpullDB.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("C:/Users/a21martinqr/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/cambioprocar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actioncambioprocar.setIcon(icon7)
        ...
        self.actionInformes_Vehiculos.setIcon(icon7)
    ...
    def retranslateUi(self, ventMain):
        ...
        item.setText(_translate("ventMain", "Matricula"))
        self.btnGuardaFac.setText(_translate("ventMain", "Guardar"))
        self.btnModifcli_2.setText(_translate("ventMain", "Modificar"))
        self.btnBorracli_2.setText(_translate("ventMain", "Eliminar"))
        ...
        self.lblFactura_2.setText(_translate("ventMain", "DNI/N Factura"))
        ...
        self.btnProecesarVenta.setText(_translate("ventMain", "Procesar Venta"))
