...
class Ui_ventMain(object):
    def setupUi(self, ventMain):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/informe-cliente.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/informe-coche.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/salida.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSalir.setIcon(icon5)
        self.actionSalir.setObjectName("actionSalir")
        self.actionSalibar = QtGui.QAction(ventMain)
        self.actionSalibar.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/pushDB.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionpushDB.setIcon(icon6)
        self.actionpushDB.setObjectName("actionpushDB")
        self.actionpullDB = QtGui.QAction(ventMain)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/pullDB.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionpullDB.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/GitHub/Desenvolvemento-de-Interfaces/QuintanaRana\\img/cambioprocar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actioncambioprocar.setIcon(icon8)
        ...
        self.actionInformes_Vehiculos.setIcon(icon8)
