...
class Ui_ventMain(object):
    def setupUi(self, ventMain):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../../../.designer/backup/img/lupa.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../../../../.designer/backup/img/limpiar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
