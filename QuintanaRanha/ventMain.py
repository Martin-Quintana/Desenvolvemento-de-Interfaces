# Form implementation generated from reading ui file 'C:/Users/marti/Documents/Clase CS 2 DAM/Desenvolvemento-de-Interfaces/QuintanaRanha/ventMain.ui'
#
...
class Ui_ventMain(object):
    def setupUi(self, ventMain):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/Clase CS 2 DAM/Desenvolvemento-de-Interfaces/QuintanaRanha\\img/lupa.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/Clase CS 2 DAM/Desenvolvemento-de-Interfaces/QuintanaRanha\\img/calendar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/Clase CS 2 DAM/Desenvolvemento-de-Interfaces/QuintanaRanha\\img/limpiar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.lblgestionservicios = QtWidgets.QLabel(self.tab_3)
        self.lblgestionservicios.setGeometry(QtCore.QRect(300, 20, 191, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lblgestionservicios.setFont(font)
        self.lblgestionservicios.setObjectName("lblgestionservicios")
        self.lblCodigo = QtWidgets.QLabel(self.tab_3)
        self.lblCodigo.setGeometry(QtCore.QRect(40, 60, 48, 16))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(20, 90, 66, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txtCodigo.setGeometry(QtCore.QRect(100, 60, 113, 20))
        self.txtCodigo.setObjectName("txtCodigo")
        self.txtConcepto = QtWidgets.QLineEdit(self.tab_3)
        self.txtConcepto.setGeometry(QtCore.QRect(100, 90, 301, 20))
        self.txtConcepto.setObjectName("txtConcepto")
        self.label_2 = QtWidgets.QLabel(self.tab_3)
        self.label_2.setGeometry(QtCore.QRect(430, 90, 101, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txtPrecio.setGeometry(QtCore.QRect(540, 90, 113, 20))
        self.txtPrecio.setObjectName("txtPrecio")
        self.line_3 = QtWidgets.QFrame(self.tab_3)
        self.line_3.setGeometry(QtCore.QRect(0, 190, 791, 16))
        self.line_3.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_3.setObjectName("line_3")
        self.tabProductos = QtWidgets.QTableWidget(self.tab_3)
        self.tabProductos.setGeometry(QtCore.QRect(10, 210, 771, 311))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(270, 140, 239, 25))
        ...
        self.horizontalLayout_6.addWidget(self.btnGuardaServicio)
        self.btnModificarServicio = QtWidgets.QPushButton(self.layoutWidget1)
        self.btnModificarServicio.setObjectName("btnModificarServicio")
        self.horizontalLayout_6.addWidget(self.btnModificarServicio)
        self.btnEliminarServicio = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/Clase CS 2 DAM/Desenvolvemento-de-Interfaces/QuintanaRanha\\img/salida.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/Clase CS 2 DAM/Desenvolvemento-de-Interfaces/QuintanaRanha\\img/pushDB.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionpushDB.setIcon(icon4)
        self.actionpushDB.setObjectName("actionpushDB")
        self.actionpullDB = QtGui.QAction(ventMain)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/Clase CS 2 DAM/Desenvolvemento-de-Interfaces/QuintanaRanha\\img/pullDB.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("C:/Users/marti/Documents/Clase CS 2 DAM/Desenvolvemento-de-Interfaces/QuintanaRanha\\img/cambioprocar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, ventMain):
        ...
        self.lblgestionservicios.setText(_translate("ventMain", "GESTION DE SERVICIOS"))
        self.lblCodigo.setText(_translate("ventMain", "Codigo:"))
        self.label.setText(_translate("ventMain", "Concepto:"))
        self.label_2.setText(_translate("ventMain", "Precio/Unidad:"))
        ...
        self.btnModificarServicio.setText(_translate("ventMain", "Modificar"))
        self.btnEliminarServicio.setText(_translate("ventMain", "Eliminar"))
