...
class Ui_ventMain(object):
    def setupUi(self, ventMain):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("img/papelera.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 120, 201, 401))
        ...
        self.btnGuardacli_2 = QtWidgets.QPushButton(self.layoutWidget_7)
        self.btnGuardacli_2.setMinimumSize(QtCore.QSize(75, 20))
        self.btnGuardacli_2.setMaximumSize(QtCore.QSize(275, 20))
        self.btnGuardacli_2.setObjectName("btnGuardacli_2")
        self.horizontalLayout_7.addWidget(self.btnGuardacli_2)
        ...
        self.txtDni_2 = QtWidgets.QLineEdit(self.layoutWidget1)
        self.txtDni_2.setMinimumSize(QtCore.QSize(100, 20))
        self.txtDni_2.setMaximumSize(QtCore.QSize(100, 20))
        self.txtDni_2.setStyleSheet("background-color: rgb(197, 236, 230);")
        ...
        self.txtDni_3 = QtWidgets.QLineEdit(self.layoutWidget1)
        self.txtDni_3.setMinimumSize(QtCore.QSize(100, 20))
        self.txtDni_3.setMaximumSize(QtCore.QSize(100, 20))
        self.txtDni_3.setStyleSheet("background-color: rgb(197, 236, 230);")
        self.txtDni_3.setObjectName("txtDni_3")
        self.horizontalLayout_8.addWidget(self.txtDni_3)
        ...
        self.txtDni_4 = QtWidgets.QLineEdit(self.layoutWidget1)
        self.txtDni_4.setMinimumSize(QtCore.QSize(100, 20))
        self.txtDni_4.setMaximumSize(QtCore.QSize(100, 20))
        self.txtDni_4.setStyleSheet("background-color: rgb(197, 236, 230);")
        self.txtDni_4.setObjectName("txtDni_4")
        self.horizontalLayout_8.addWidget(self.txtDni_4)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../../../../../.designer/backup/img/lupa.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.tableWidget_2.setGeometry(QtCore.QRect(0, 0, 541, 351))
        ...
        self.pushButton.setGeometry(QtCore.QRect(210, 360, 91, 23))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("img/salida.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("img/pushDB.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionpushDB.setIcon(icon5)
        self.actionpushDB.setObjectName("actionpushDB")
        self.actionpullDB = QtGui.QAction(ventMain)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/pullDB.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("img/cambioprocar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, ventMain):
        ...
        item.setText(_translate("ventMain", "DNI"))
        self.btnGuardacli_2.setText(_translate("ventMain", "Guardar"))
        ...
        self.pushButton.setText(_translate("ventMain", "Procesar Venta"))
